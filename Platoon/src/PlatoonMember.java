...
public class PlatoonMember {
	...
	private boolean joinPlatoon() {
		...
		blockCurrent = ServerDemo.requestBlock();
	 ...
	 * needs to be encrypted before returning to server. Also
	 * needs to be part of block chain.
	 * 
	 * @return */
	public Block getSpeed() {
		updateGPS();
		...
		return new Block(speed, blockOld.getHash());
	}
